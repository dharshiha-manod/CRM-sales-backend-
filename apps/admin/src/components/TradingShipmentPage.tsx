...
const config: TradingModuleConfig = {
 ...
 { key: 'deal_number', label: 'Deal', type: 'lookup', lookupResource: '/trading/deals', lookupLabelKey: 'deal_name', autoFillMap: { customer_name: 'customer_name', supplier_name: 'supplier_name', product_name: 'product_name', unit: 'unit', currency: 'currency' }, listColumn: true },
    ...
    { key: 'shipment_date', label: 'Shipment date', type: 'date', group: 'Schedule' },
    ...
    { key: 'status', label: 'Shipment status', type: 'select', options: STATUSES, listColumn: true, group: 'Route' },
