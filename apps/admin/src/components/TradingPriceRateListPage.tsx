...
const config: TradingModuleConfig = {
  ...
  fields: [
   ...
   { key: 'purchase_rate', label: 'Purchase rate', type: 'number', group: 'Rate', visibleIf: (f) => !f.rate_type || f.rate_type === 'Purchase Rate' || f.rate_type === 'Supplier-specific Rate' },
    { key: 'selling_rate', label: 'Selling rate', type: 'number', group: 'Rate', visibleIf: (f) => !f.rate_type || f.rate_type === 'Selling Rate' || f.rate_type === 'Wholesale Rate' || f.rate_type === 'Retail Rate' || f.rate_type === 'Customer-specific Rate' },
