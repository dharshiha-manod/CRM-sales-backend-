...
export const TRADING_RESOURCES: TradingResource[] = [
  ...
  },
  {
    ...
    requiredFields: ['enquiry_number', 'product_name'],
       columns: ['enquiry_number', 'enquiry_date', 'required_by_date', 'product_name', 'quantity', 'unit', 'specification', 'supplier_name', 'requested_rate', 'currency', 'delivery_location', 'delivery_terms', 'payment_terms', 'procurement_person', 'notes', 'industry_type_id'],
  },
  {
    path: 'price-lists',
...
columns: ['shipment_number', 'deal_number', 'customer_name', 'supplier_name', 'product_name', 'quantity', 'unit', 'batch_serial', 'shipment_date', 'pickup_date', 'expected_delivery_date', 'actual_delivery_date', 'origin', 'destination', 'transporter', 'tracking_number', 'vehicle_container_number', 'shipping_mode', 'driver_contact', 'distance', 'current_location', 'freight_cost', 'notes', 'industry_type_id'],
  },
  {
    path: 'documents',
  ...
  columns: ['document_id', 'document_number', 'document_type', 'deal_number', 'shipment_number', 'customer_name', 'supplier_name', 'product_name', 'reference_number', 'issue_date', 'expiry_date', 'issued_by', 'uploaded_by', 'file_reference', 'verification_status', 'notes', 'industry_type_id'],
  },
  {
    path: 'currency-rates',
...
columns: ['transaction_number', 'transaction_type', 'deal_number', 'customer_name', 'supplier_name', 'product_name', 'quantity', 'unit', 'country_of_origin', 'destination_country', 'port_of_loading', 'port_of_discharge', 'shipment_number', 'shipping_mode', 'invoice_number', 'currency', 'total_value', 'incoterm', 'expected_shipment_date', 'expected_arrival_date', 'actual_arrival_date', 'notes', 'industry_type_id'],
  },
  {
    path: 'customs',
   ...
   columns: ['customs_reference', 'shipment_number', 'transaction_number', 'transaction_type', 'customer_name', 'supplier_name', 'product_name', 'hs_code', 'quantity', 'country_of_origin', 'destination_country', 'port', 'declared_value', 'currency', 'customs_broker', 'declaration_date', 'customs_duty', 'other_charges', 'inspection_status', 'clearance_date', 'clearance_status', 'notes', 'industry_type_id'],
  },
  {
    path: 'claims',
  ...
  },
  {
    ...
    columns: ['commission_number', 'sales_rep', 'deal_number', 'customer_name', 'product_name', 'quantity', 'purchase_value', 'selling_value', 'commission_basis', 'commission_rate', 'currency', 'eligible_date', 'calculation_date', 'approval_date', 'payment_date', 'notes', 'industry_type_id'],
  },
  {
    path: 'profitability',
    ...
    columns: ['deal_number', 'customer_name', 'supplier_name', 'product_name', 'quantity', 'currency', 'exchange_rate', 'period', 'purchase_rate', 'selling_rate', 'freight', 'insurance', 'customs_duty', 'port_charges', 'handling_charges', 'logistics_cost', 'commission', 'other_costs', 'notes', 'industry_type_id'],
  },
  {
    path: 'compliance',
    ...
    columns: ['compliance_reference', 'compliance_type', 'deal_number', 'customer_name', 'supplier_name', 'product_name', 'shipment_number', 'transaction_number', 'country', 'hs_code', 'document_status', 'risk_level', 'check_date', 'checked_by', 'required_action', 'due_date', 'approval_status', 'exception_reason', 'resolution', 'notes', 'industry_type_id'],
  },
  {
    path: 'trade-finance',
...
columns: ['lc_number', 'lc_type', 'deal_number', 'customer_name', 'supplier_name', 'issuing_bank', 'advising_bank', 'confirming_bank', 'applicant', 'beneficiary', 'currency', 'lc_amount', 'tolerance_percent', 'issue_date', 'expiry_date', 'latest_shipment_date', 'presentation_period', 'port_place', 'payment_terms', 'document_requirements', 'notes', 'industry_type_id'],
  },
];
